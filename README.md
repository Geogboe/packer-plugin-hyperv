...
You can find pre-built binary releases of the plugin [here](https://github.com/smnsjas/packer-plugin-hyperv/releases).
...
directory. Upon successful compilation, a `packer-plugin-hyperv` plugin
